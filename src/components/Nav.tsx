    ...
    <nav className='bg-white flex flex-col sm:flex-row gap-5 items-center font-Inter justify-between px-5  p-3 '>
        ...
        <div className='flex justify-center sm:justify-between flex-wrap sm:flex-nowrap gap-3 w-[95%] sm:w-[70%] ' >
            <div className='relative'>
                <input placeholder="Search by patients..." type="text" className='p-2 pl-9 w-[13em]  md:w-[17em] placeholder:text-[#4F5867] text-[0.8rem] sm:text-[0.9rem]  rounded-lg border-[1.5px] border-[#CDCFD4] focus:outline-none '/>
            ...
            <div className='flex gap-3 sm:gap-7 items-center'>
                ...
                <div className='flex gap-4 items-center'>
                        <img src={doctor} alt='doctor-jpg' className='bg-[#F7F6FF] w-[34px]  rounded-full'/>
